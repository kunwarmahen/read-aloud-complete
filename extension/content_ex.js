      ...
      <div class="panel-content">
        ...
        <div class="auth-section" id="auth-section">
          <div id="auth-status" class="auth-status">
            ...
            <button id="auth-action-btn" class="mini-btn">Login</button>
          </div>
        </div>
        ...
        <div id="auth-modal" class="auth-modal" style="display: none;">
          <div class="auth-modal-content">
            ...
            <button id="auth-cancel-btn" class="auth-link">Cancel</button>
          </div>
        </div>

        <!-- Cloud Save Section -->
        <div class="cloud-section" id="cloud-section" style="display: none;">
        ...
        <div class="cast-section" id="cast-section" style="display: none;">
          <button id="cast-btn" class="mini-btn" style="width: 100%;">
            ...
            <span id="cast-text">Setup Cast Device</span>
          </button>
        </div>
...
function setupAuthListeners() {
  ...
  saveToCloudBtn.addEventListener("click", saveCurrentToCloud);
}
...
function updateAuthUI() {
  ...
  if (isAuthenticated) {
    ...
    authUserInfo.textContent = userInfo.name || userInfo.email;
...
async function loadCollections() {
  ...
  select.style.display = collections.length > 0 ? "block" : "none";
}
...
async function saveCurrentToCloud() {
  ...
  // Get title from page or use first few words
